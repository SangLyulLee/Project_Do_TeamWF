    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String[] api_split = get_api.getBusRouteNoList(citycode, input_str).split("\n");
                if (api_split[0].equals("")) {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    databaseReference.child(Integer.toString(data_pos)).child("routeno").setValue(input_str);
                            ...
                            handler.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(DriverSelect_api.this, DriverMain.class);
